...
function FloatingPlayer() {
  ...
  const prev = () => switchToTrack((trackIdx - 1 + TRACKS.length) % TRACKS.length);
  const next = () => switchToTrack((trackIdx + 1) % TRACKS.length);
  ...
  return (
    <>
      <audio ref={audioRef} onTimeUpdate={onTimeUpdate} onLoadedMetadata={onLoadedMetadata} onEnded={onEnded} onCanPlay={onCanPlay} preload="none" />
